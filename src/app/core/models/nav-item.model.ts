...
export const NAVIGATION_DATA: NavItem[] = [
    ...
    children: [
      {
        ...
        link: '/operator-console/edit-my-profile',
        icon: 'person_edit.svg',
      },
      {
        label: 'View All Profiles',
        link: '/operator-console/view-all-profiles',
  ...
  },
  {
    ...
    children: [
      ...
      {
        label: 'Define Campaigns',
        link: '/campaigns/define-campaign',
        icon: 'quick_reference_all.svg',
      },
      ...
      {
        label: 'Access Property View',
        link: '/coming-soon/access-property-view',
        icon: 'real-estate-property.svg',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    children: [
      {
        label: 'Property Welcome',
        link: '/coming-soon/property-welcome',
        icon: 'PropertyWelcome.svg',
      },
      {
        label: 'Hospitality Professional!',
        link: '/coming-soon/hospitality-professional',
        icon: 'HospitalityProfessional.svg',
      },
      ...
      {
        label: 'Personalized-to-Pocket',
        link: '/coming-soon/personalized-to-pocket',
        icon: 'Personalized-to-Pocket.svg',
      },
  ...
  },
  {
    ...
    children: [
      { label: 'Job Guides', link: '/coming-soon/job-guides', icon: 'JobGuides.svg' },
      {
        ...
        link: '/coming-soon/daily-briefings',
        icon: 'DailyBriefings.svg',
      },
      { label: 'Orientation', link: '/coming-soon/orientation', icon: 'Orientation.svg' },
      {
        label: 'Team Quality Requirements',
        link: '/coming-soon/team-quality-requirements',
        icon: 'TeamQualityRequirements.svg',
      },
      {
        label: 'GXM Exceptional Service',
        link: '/coming-soon/gxm-exceptional-service',
        icon: 'GXMExceptionalService.svg',
      },
      {
        label: 'OXM Operating Standards',
        link: '/coming-soon/oxm-operating-standards',
        icon: 'OXMOperatingStandards.svg',
      },
      {
        label: 'DXM Progress Reports',
        link: '/coming-soon/dxm-progress-reports',
        icon: 'DXMProgressReports.svg',
      },
      {
        label: 'Achievement Certification',
        link: '/coming-soon/achievement-certification',
        icon: 'AchievementCertification.svg',
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        link: '/coming-soon/property-details',
        icon: 'PropertyDetails.svg',
      },
  ...
  },
  {
    ...
    children: [
      {
        label: 'GM Access Credentials',
        link: '/coming-soon/gm-access-credentials',
        icon: 'GMAccessCredentials.svg',
      },
    ...
    children: [
      {
        ...
        children: [
          {
            label: 'License Parties',
            link: '/coming-soon/license-parties',
            icon: 'LicenseParties.svg',
          },
        ],
      },
      { label: 'Pricing', link: '/coming-soon/pricing', icon: 'Pricing.svg' },
      {
        ...
        children: [
          {
            label: 'Tenure & On Cost',
            link: '/coming-soon/tenure-on-cost',
            icon: 'TenureOnCost.svg',
          },
      ...
      },
      {
        ...
        link: '/coming-soon/approval-purchase-order',
        icon: 'ApprovalPurchaseOrder.svg',
      },
